...
import { ref, mergeProps, unref, useSSRContext, computed, onUnmounted, withCtx, createVNode, createTextVNode, toDisplayString, resolveComponent } from 'file:///Users/apple/Desktop/website/LDC_website/node_modules/vue/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_FbCustomerChat, null, null, _parent));
      _push(`</div>`);
    };
  }
};
...
//# sourceMappingURL=default-3aa3f040.mjs.map
