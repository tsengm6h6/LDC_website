...
import { ref, unref, useSSRContext, computed, onUnmounted, withCtx, createVNode, createTextVNode, toDisplayString, mergeProps } from 'file:///Users/apple/Desktop/website/LDC_website/node_modules/vue/index.mjs';
import { u as useAsyncData } from './query-8ce04585.mjs';
import { f as fetchContentNavigation } from './navigation-14a2574d.mjs';
import { ssrRenderAttrs, ssrRenderClass, ssrRenderComponent, ssrRenderSlot, ssrRenderAttr, ssrRenderList, ssrInterpolate } from 'file:///Users/apple/Desktop/website/LDC_website/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="${ssrRenderClass(`w-full ${unref(isMenuToggled) ? "overflow-hidden" : "overflow-auto"}`)}"><div class="${ssrRenderClass(`${unref(isMenuToggled) ? "block" : "hidden"} fixed z-40 h-screen w-full bg-black/20 backdrop-blur-sm md:z-0 md:hidden`)}"></div>`);
      ...
      _push(`</div><div id="fb-root"></div></div>`);
    };
  }
};
...
//# sourceMappingURL=default-858bb263.mjs.map
