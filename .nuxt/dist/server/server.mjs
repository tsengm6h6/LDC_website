import { hasInjectionContext, getCurrentInstance, reactive, version, unref, inject, ref, watchEffect, watch, toRef, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, nextTick, shallowRef, computed, isReadonly, h, defineComponent, Transition, Suspense, provide, withCtx, createVNode, useSSRContext, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
import { getActiveHead, createServerHead as createServerHead$1, unpackMeta, composableNames } from "unhead";
...
const LazyProseStrong = defineAsyncComponent(() => import("./_nuxt/ProseStrong-f2542d54.js").then((r) => r.default));
const LazyProseTable = defineAsyncComponent(() => import("./_nuxt/ProseTable-17916116.js").then((r) => r.default));
const LazyProseTbody = defineAsyncComponent(() => import("./_nuxt/ProseTbody-f139d924.js").then((r) => r.default));
const LazyProseTd = defineAsyncComponent(() => import("./_nuxt/ProseTd-02d9e6b4.js").then((r) => r.default));
const LazyProseTh = defineAsyncComponent(() => import("./_nuxt/ProseTh-4cfa0bd0.js").then((r) => r.default));
...
const layouts = {
  default: () => import("./_nuxt/default-3aa3f040.js").then((m) => m.default || m)
};
