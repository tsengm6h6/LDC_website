...
import "devalue";
import "klona";
import { q as queryContent, e as encodeQueryParams, j as jsonStringify } from "./query-8ce04585.js";
...
const fetchContentNavigation = async (queryBuilder) => {
  ...
  if (shouldUseClientDB()) {
    const generateNavigation = await import("./client-db-db0d294c.js").then((m) => m.generateNavigation);
...
//# sourceMappingURL=navigation-14a2574d.js.map
